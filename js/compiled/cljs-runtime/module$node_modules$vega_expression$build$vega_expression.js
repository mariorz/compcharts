...
var token=parseExpression();expect(")");return token}if(match("[")){token=[];index$jscomp$0=lookahead.start;for(expect("[");!match("]");)match(",")?(lex(),token.push(null)):(token.push(parseConditionalExpression()),match("]")||expect(","));lex();var JSCompiler_object_inline_value_3314=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_3314.elements=token;return JSCompiler_object_inline_value_3314}if(match("{")){token=[];JSCompiler_object_inline_value_3314={};var JSCompiler_object_inline_literal_3315=
String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_3316=lookahead;if(3===JSCompiler_object_inline_value_3316.type){var JSCompiler_object_inline_literal_3317=parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_3316=parseConditionalExpression();JSCompiler_object_inline_value_3316=finishProperty("init",JSCompiler_object_inline_literal_3317,JSCompiler_object_inline_value_3316)}else 2===JSCompiler_object_inline_value_3316.type||
7===JSCompiler_object_inline_value_3316.type?(throwUnexpected(JSCompiler_object_inline_value_3316),JSCompiler_object_inline_value_3316=void 0):(JSCompiler_object_inline_literal_3317=parseObjectPropertyKey(),expect(":"),JSCompiler_object_inline_value_3316=parseConditionalExpression(),JSCompiler_object_inline_value_3316=finishProperty("init",JSCompiler_object_inline_literal_3317,JSCompiler_object_inline_value_3316));JSCompiler_object_inline_literal_3317="Identifier"===JSCompiler_object_inline_value_3316.key.type?
JSCompiler_object_inline_value_3316.key.name:JSCompiler_object_inline_literal_3315(JSCompiler_object_inline_value_3316.key.value);JSCompiler_object_inline_literal_3317="$"+JSCompiler_object_inline_literal_3317;Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_3314,JSCompiler_object_inline_literal_3317)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_3314[JSCompiler_object_inline_literal_3317]=!0;token.push(JSCompiler_object_inline_value_3316);
match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_3314=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_3314.properties=token;return JSCompiler_object_inline_value_3314}JSCompiler_object_inline_value_3314=lookahead.type;index$jscomp$0=lookahead.start;if(3===JSCompiler_object_inline_value_3314||legalKeywords[lookahead.value])token=finishIdentifier(lex().value);else if(8===JSCompiler_object_inline_value_3314||6===JSCompiler_object_inline_value_3314)lookahead.octal&&throwError(lookahead,
"Octal literals are not allowed in strict mode."),token=finishLiteral(lex());else{if(4===JSCompiler_object_inline_value_3314)throw Error("Disabled.");if(1===JSCompiler_object_inline_value_3314)token=lex(),token.value="true"===token.value,token=finishLiteral(token);else if(5===JSCompiler_object_inline_value_3314)token=lex(),token.value=null,token=finishLiteral(token);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();token=index$jscomp$0;JSCompiler_object_inline_value_3314=
source[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_3314,"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_3315=source[index$jscomp$0++];for(JSCompiler_object_inline_literal_3317=JSCompiler_object_inline_value_3316=!1;index$jscomp$0<length;)if(JSCompiler_object_inline_value_3314=source[index$jscomp$0++],JSCompiler_object_inline_literal_3315+=JSCompiler_object_inline_value_3314,"\\"===JSCompiler_object_inline_value_3314)JSCompiler_object_inline_value_3314=
source[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_3314.charCodeAt(0))&&throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_3315+=JSCompiler_object_inline_value_3314;else if(isLineTerminator(JSCompiler_object_inline_value_3314.charCodeAt(0)))throwError({},"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_3316)"]"===JSCompiler_object_inline_value_3314&&(JSCompiler_object_inline_value_3316=!1);else if("/"===JSCompiler_object_inline_value_3314){JSCompiler_object_inline_literal_3317=
!0;break}else"["===JSCompiler_object_inline_value_3314&&(JSCompiler_object_inline_value_3316=!0);JSCompiler_object_inline_literal_3317||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_3314=JSCompiler_object_inline_literal_3315.substr(1,JSCompiler_object_inline_literal_3315.length-2);for(value=JSCompiler_object_inline_literal_3317="";index$jscomp$0<length;){JSCompiler_object_inline_value_3316=source[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_3316.charCodeAt(0)))break;
++index$jscomp$0;"\\"===JSCompiler_object_inline_value_3316&&index$jscomp$0<length?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_3316,JSCompiler_object_inline_literal_3317+=JSCompiler_object_inline_value_3316)}0<=value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_3316=value;value=testRegExp(JSCompiler_object_inline_value_3314,JSCompiler_object_inline_value_3316);token=finishLiteral({literal:JSCompiler_object_inline_literal_3315+
JSCompiler_object_inline_literal_3317,value:value,regex:{pattern:JSCompiler_object_inline_value_3314,flags:JSCompiler_object_inline_value_3316},start:token,end:index$jscomp$0});JSCompiler_object_inline_value_3314=index$jscomp$0;lookahead=advance();index$jscomp$0=JSCompiler_object_inline_value_3314}else throwUnexpected(lex())}return token}function parsePostfixExpression(){var JSCompiler_inline_result;for(JSCompiler_inline_result=parsePrimaryExpression();;)if(match(".")){expect(".");index$jscomp$0=
