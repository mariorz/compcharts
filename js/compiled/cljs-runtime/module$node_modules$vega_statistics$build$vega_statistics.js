...
d3Array){function numbers(values,valueof){var index,$jscomp$iter$100,$jscomp$key$value,value$416,$jscomp$iter$99,value;return $jscomp.generator.createGenerator(numbers,function($jscomp$generator$context){switch($jscomp$generator$context.nextAddress){case 1:if(null==valueof){$jscomp$generator$context.jumpTo(2);break}index=-1;$jscomp$iter$100=$jscomp.makeIterator(values);$jscomp$key$value=$jscomp$iter$100.next();case 4:if($jscomp$key$value.done){$jscomp$generator$context.jumpTo(0);break}value$416=$jscomp$key$value.value;
value$416=valueof(value$416,++index,values);if(!(null!=value$416&&""!==value$416&&(value$416=+value$416)>=value$416)){$jscomp$generator$context.jumpTo(5);break}return $jscomp$generator$context.yield(value$416,5);case 5:$jscomp$key$value=$jscomp$iter$100.next();$jscomp$generator$context.jumpTo(4);break;case 2:$jscomp$iter$99=$jscomp.makeIterator(values),$jscomp$key$value=$jscomp$iter$99.next();case 9:if($jscomp$key$value.done){$jscomp$generator$context.jumpTo(0);break}value=$jscomp$key$value.value;
if(!(null!=value&&""!==value&&(value=+value)>=value)){$jscomp$generator$context.jumpTo(10);break}return $jscomp$generator$context.yield(value,10);case 10:$jscomp$key$value=$jscomp$iter$99.next(),$jscomp$generator$context.jumpTo(9)}})}function quantiles(array,p,f){var values=Float64Array.from(numbers(array,f));values.sort(d3Array.ascending);return p.map(function(_){return d3Array.quantileSorted(values,_)})}function quartiles(array,f){return quantiles(array,[.25,.5,.75],f)}function estimateBandwidth(array,
...
y){var X=0,Y=0,XY=0,X2=0,n=0;visitPoints(data,x$jscomp$0,y,function(dx,dy){++n;X+=(dx-X)/n;Y+=(dy-Y)/n;XY+=(dx*dy-XY)/n;X2+=(dx*dx-X2)/n});var coef=ols(X,Y,XY,X2),predict=function(x){return coef[0]+coef[1]*x};return{coef:coef,predict:predict,rSquared:rSquared(data,x$jscomp$0,y,Y,predict)}}function quad(data,x$jscomp$0,y){var $jscomp$destructuring$var12=$jscomp.makeIterator(points(data,x$jscomp$0,y)),xv=$jscomp$destructuring$var12.next().value,yv=$jscomp$destructuring$var12.next().value,ux=$jscomp$destructuring$var12.next().value,
uy=$jscomp$destructuring$var12.next().value,n=xv.length,X3=$jscomp$destructuring$var12=0,X4=0,XY=0,X2Y=0,i;for(i=0;i<n;){var dx=xv[i];var dy=yv[i++];var x2=dx*dx;$jscomp$destructuring$var12+=(x2-$jscomp$destructuring$var12)/i;X3+=(x2*dx-X3)/i;X4+=(x2*x2-X4)/i;XY+=(dx*dy-XY)/i;X2Y+=(x2*dy-X2Y)/i}xv=X4-$jscomp$destructuring$var12*$jscomp$destructuring$var12;yv=$jscomp$destructuring$var12*xv-X3*X3;var a=(X2Y*$jscomp$destructuring$var12-XY*X3)/yv,b=(XY*xv-X2Y*X3)/yv,c=-a*$jscomp$destructuring$var12;$jscomp$destructuring$var12=
function(x){x-=ux;return a*x*x+b*x+c+uy};return{coef:[c-b*ux+a*ux*ux+uy,b-2*a*ux,a],predict:$jscomp$destructuring$var12,rSquared:rSquared(data,x$jscomp$0,y,uy,$jscomp$destructuring$var12)}}function uncenter(k,a,x,y){var z=Array(k),i;for(i=0;i<k;++i)z[i]=0;for(i=k-1;0<=i;--i){var v=a[i];var c=1;z[i]+=v;for(k=1;k<=i;++k)c*=(i+1-k)/k,z[i-k]+=v*Math.pow(x,k)*c}z[0]+=y;return z}function gaussianElimination(matrix){var n=matrix.length-1,coef=[],i,j,k;for(i=0;i<n;++i){var r=i;for(j=i+1;j<n;++j)Math.abs(matrix[i][j])>
...
b)},pdf:function(value){return densityUniform(value,a,b)},cdf:function(value){return cumulativeUniform(value,a,b)},icdf:function(p){return quantileUniform(p,a,b)}};null==max&&(max=null==min?1:min,min=0);return dist.min(min).max(max)};exports.regressionExp=function(data,x$jscomp$0,y){var $jscomp$destructuring$var10=$jscomp.makeIterator(points(data,x$jscomp$0,y)),xv=$jscomp$destructuring$var10.next().value;$jscomp$destructuring$var10.next();var ux=$jscomp$destructuring$var10.next().value;$jscomp$destructuring$var10=
$jscomp$destructuring$var10.next().value;var YL=0,XY=0,XYL=0,X2Y=0,n=0,dx,ly,xy;visitPoints(data,x$jscomp$0,y,function(_,dy){dx=xv[n++];ly=Math.log(dy);xy=dx*dy;YL+=(dy*ly-YL)/n;XY+=(xy-XY)/n;XYL+=(xy*ly-XYL)/n;X2Y+=(dx*xy-X2Y)/n});var $jscomp$destructuring$var11=$jscomp.makeIterator(ols(XY/$jscomp$destructuring$var10,YL/$jscomp$destructuring$var10,XYL/$jscomp$destructuring$var10,X2Y/$jscomp$destructuring$var10)),c0=$jscomp$destructuring$var11.next().value,c1=$jscomp$destructuring$var11.next().value;
$jscomp$destructuring$var11=function(x){return Math.exp(c0+c1*(x-ux))};return{coef:[Math.exp(c0-c1*ux),c1],predict:$jscomp$destructuring$var11,rSquared:rSquared(data,x$jscomp$0,y,$jscomp$destructuring$var10,$jscomp$destructuring$var11)}};exports.regressionLinear=linear;exports.regressionLoess=function(data,x$jscomp$0,y,bandwidth){y=$jscomp.makeIterator(points(data,x$jscomp$0,y,!0));data=y.next().value;var yv=y.next().value;x$jscomp$0=y.next().value;y=y.next().value;var n=data.length,bw=Math.max(2,
...
return{coef:coef,predict:predict,rSquared:rSquared(data,x$jscomp$0,y,Y,predict)}};exports.regressionPoly=function(data,x$jscomp$0,y$jscomp$0,order){if(1===order)return linear(data,x$jscomp$0,y$jscomp$0);if(2===order)return quad(data,x$jscomp$0,y$jscomp$0);var $jscomp$destructuring$var13=$jscomp.makeIterator(points(data,x$jscomp$0,y$jscomp$0)),xv=$jscomp$destructuring$var13.next().value,yv=$jscomp$destructuring$var13.next().value,ux=$jscomp$destructuring$var13.next().value,uy=$jscomp$destructuring$var13.next().value;
$jscomp$destructuring$var13=xv.length;var lhs=[],rhs=[],k=order+1,i,l,v;for(i=0;i<k;++i){for(v=l=0;l<$jscomp$destructuring$var13;++l)v+=Math.pow(xv[l],i)*yv[l];lhs.push(v);var c=new Float64Array(k);for(order=0;order<k;++order){for(v=l=0;l<$jscomp$destructuring$var13;++l)v+=Math.pow(xv[l],i+order);c[order]=v}rhs.push(c)}rhs.push(lhs);var coef=gaussianElimination(rhs);xv=function(x){x-=ux;var y=uy+coef[0]+coef[1]*x+coef[2]*x*x;for(i=3;i<k;++i)y+=coef[i]*Math.pow(x,i);return y};return{coef:uncenter(k,
