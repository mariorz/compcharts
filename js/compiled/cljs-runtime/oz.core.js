...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__52037){
var vec__52038 = p__52037;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52038,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52038,(1),null);
...
}),new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),(function (this$,p__52041){
var vec__52042 = p__52041;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52042,(0),null);
var new_spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52042,(1),null);
...
if(cljs.core.truth_(((cljs.core.coll_QMARK_(x))?(function (){var G__52048 = cljs.core.first(x);
var fexpr__52047 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vega","vega",-1657843081),null,new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),null], null), null);
return (fexpr__52047.cljs$core$IFn$_invoke$arity$1 ? fexpr__52047.cljs$core$IFn$_invoke$arity$1(G__52048) : fexpr__52047.call(null,G__52048));
})():false))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__52049 = cljs.core.first(x);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52049__$1)].join('')));
