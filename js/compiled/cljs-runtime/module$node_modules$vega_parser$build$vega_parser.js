...
0;this._subid=++scope._nextsub[0];this._nextsub=scope._nextsub;this._parent=scope._parent.slice();this._encode=scope._encode.slice();this._lookup=scope._lookup.slice();this._markpath=scope._markpath}function propertyLambda(spec){return(vegaUtil.isArray(spec)?arrayLambda:objectLambda)(spec)}function arrayLambda(array){for(var n=array.length,code="[",i=0;i<n;++i){var value$507=array[i];code+=(0<i?",":"")+(vegaUtil.isObject(value$507)?value$507.signal||propertyLambda(value$507):vegaUtil.stringValue(value$507))}return code+
