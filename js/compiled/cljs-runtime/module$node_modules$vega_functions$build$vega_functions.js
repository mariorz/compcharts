...
utcweek:vegaTime.utcweek,dayofyear:vegaTime.dayofyear,utcdayofyear:vegaTime.utcdayofyear,warn:warn,info:info,debug:debug,extent:vegaUtil.extent,inScope:inScope,intersect:function(b,opt,group){if(!b)return[];var $jscomp$destructuring$var60=$jscomp.makeIterator(b);b=$jscomp$destructuring$var60.next().value;$jscomp$destructuring$var60=$jscomp$destructuring$var60.next().value;b=(new vegaScenegraph.Bounds).set(b[0],b[1],$jscomp$destructuring$var60[0],$jscomp$destructuring$var60[1]);group=group||this.context.dataflow.scenegraph().root;
