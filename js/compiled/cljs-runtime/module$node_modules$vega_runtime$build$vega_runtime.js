...
op);if(spec.data){data={};for(var name in spec.data)data.$jscomp$loop$prop$data$500$676=ctx.data[name]||(ctx.data[name]={}),spec.data[name].forEach(function($jscomp$loop$675){return function(role){return $jscomp$loop$675.$jscomp$loop$prop$data$500$676[role]=op}}(data)),data={$jscomp$loop$prop$data$500$676:data.$jscomp$loop$prop$data$500$676}}},resolve:function(){(this.unresolved||[]).forEach(function(fn){return fn()});delete this.unresolved;return this},operator:function(spec,update){this.add(spec,
