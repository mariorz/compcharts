...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36134__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36134__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__36135 = data;
...
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36135__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36135__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36135__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36135__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36135__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36135__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36135__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36135__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq36148){
var G__36149 = cljs.core.first(seq36148);
var seq36148__$1 = cljs.core.next(seq36148);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36149,seq36148__$1);
}));
...
return ((function (){var G__36161 = taoensso.timbre.valid_level(x);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__36161) : taoensso.timbre._levels_map.call(null,G__36161));
})() >= (function (){var G__36162 = taoensso.timbre.valid_level(y);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__36162) : taoensso.timbre._levels_map.call(null,G__36162));
})());
});
...
var fexpr__36164 = taoensso.timbre._compile_ns_filter(whitelist,blacklist);
return (fexpr__36164.cljs$core$IFn$_invoke$arity$1 ? fexpr__36164.cljs$core$IFn$_invoke$arity$1(_QMARK_ns) : fexpr__36164.call(null,_QMARK_ns));
}));
/**
...
var vec__36172 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36172,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__36179 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36179,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__36182 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36182,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.timbre.vrest(vargs__$1):vargs__$1);
...
var instant_36343 = taoensso.encore.now_dt();
var context_36344 = taoensso.timbre._STAR_context_STAR_;
var vargs_36345 = cljs.core.deref(vargs_);
var vec__36189_36346 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_36345);
var _QMARK_err_36347__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36189_36346,(0),null);
var _QMARK_meta_36348 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36189_36346,(1),null);
var _QMARK_msg_fmt_36349 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36189_36346,(2),null);
var vargs_36350__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36189_36346,(3),null);
var data_36351 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4126__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_36343,config,vargs_36350__$1,_QMARK_file,(function (){var fexpr__36193 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__36193.cljs$core$IFn$_invoke$arity$1 ? fexpr__36193.cljs$core$IFn$_invoke$arity$1(level) : fexpr__36193.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_36347__$1,context_36344,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_36347__$1;
}),null)),_QMARK_meta_36348,_QMARK_msg_fmt_36349]));
var _QMARK_data_36352 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_36351,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5735__auto___36375 = _QMARK_data_36352;
if(cljs.core.truth_(temp__5735__auto___36375)){
var data_36378__$1 = temp__5735__auto___36375;
var map__36194_36380 = data_36378__$1;
var map__36194_36381__$1 = (((((!((map__36194_36380 == null))))?(((((map__36194_36380.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36194_36380.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__36194_36380):map__36194_36380);
var vargs_36382__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36194_36381__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_36383__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_36378__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_36382__$2;
}),null)));
var data_36384__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_36383__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__36196 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__36196)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__36196)){
return taoensso.timbre.str_join(vargs_36382__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__36196)){
if(typeof _QMARK_msg_fmt_36349 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_36349,vargs_36382__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36196)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_36349,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_36348,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_36382__$2)], null));
}),null))], 0));
var output_fn1_36385 = taoensso.encore.memoize_(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
return cljs.core.not((function (){var G__36198 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_36384__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__36198) : rl_fn.call(null,G__36198));
})());
}
})();
...
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36199__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36199__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
return output_fn1_36385;
} else {
return f;
}
})();
var output_ = (new cljs.core.Delay((function (){
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(data_36384__$3) : output_fn.call(null,data_36384__$3));
}),null));
var data__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_36384__$3,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_], null));
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq36209){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36209));
}));
